    ...
    <div className='card py-6 px-6 '>
        ...
        <div className='flex flex-col items-center justify-center font-semibold'>
            ...
            <p className='my-4'>{popular.teacher}</p>
                <div className='flex my-2 justify-start items-center gap-4 pl-5 hover:bg-gray-900 p-2 rounded-md group cursor-pointer hover:shadow-lg m-auto font-semibold text-left'>
                <AiOutlineHeart className="text-2xl text-gray-600 group-hover:text-gray-400 " />
                <p className=''>{popular.favorites}</p>
                </div>
            </div>

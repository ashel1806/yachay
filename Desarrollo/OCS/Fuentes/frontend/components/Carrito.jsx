  ...
  return (
    <div>
      <button
        ...
        className="flex mb-5 justify-start items-center gap-4 pl-5 p-2 rounded-md group m-auto"
      >
            ...
            <div className="mb-1">
              <div className="flex flex-row items-center justify-end">
                ...
                <Image
                  ...
                  height={40}
                />{' '}
                Curso de A.Ilustrator
              </div>
            </div>
            <div>
              <button className="flex flex-row items-center justify-center bg-sky-500 text-white rounded-2xl py-2 px-4 ml-10">
                Pagar
              </button>
            </div>
          </div>

          ...
          <div>
                  ...
                  <div>
                    <form>
                      <div className="flex flex-row mb-4">
                        <div className="ml-14 mr-8 text-2xl">
                          {' '}
            ...
            <div className="mb-20">
              ...
              <p className="text-xl leading-8">
                Llenar estos campos no es obligatorio, sin embargo, te pueden
                ayudar a personalizar la información que se muestra a los
                estudiantes de la plataforma y<br></br>aumentar la seguridad de
                tu cuenta.{' '}
              </p>
            </div>
          </div>
              ...
              <div className="col-span-2">
                <div className="grid grid-cols-12">
                  <div className="col-span-5 grid grid-rows-3">
                    ...
                    <div className="ml-14 mr-8 text-2xl">
                      <label for="apellido">Número de Telefono :</label>
                    </div>
                    <div className="ml-14  mr-8 text-2xl">
                      <label for="Correo"> Correo de Recuperación: </label>
                    </div>
                  </div>
                  <div className="col-span-5 grid grid-rows-3">
                    <div>
